...
class ApiService {
  ...
  Future<Map<String, dynamic>> register(
    ...
    Future<Map<String, dynamic>> login(String email, String password) async {
      ...
      if (data['success'] == true && data['data'] != null) {
        ...
        // Save token and user information in shared preferences
        await prefs.setString(AppConstants.prefToken, userData['token']);
        await prefs.setString(AppConstants.prefUserId, userData['id']);
  ...
  Future<Map<String, dynamic>> predictPrice(
      String product, String market, String timeframe) async {
  ...
  Future<List<Map<String, dynamic>>> getPriceTrends(
      String product, String market) async {
  ...
  Future<List<PriceData>> getHistoricalPrices(
      String product, String market) async {
    final data = await _get('prices/history/$product/$market');
    return List<PriceData>.from(data.map((json) => PriceData.fromJson(json)));
  }

  Future<void> setUserPriceAlert(
      String product, String market, double threshold) async {
  ...
  Future<List<Map<String, dynamic>>> getAveragePricePerMarket(
